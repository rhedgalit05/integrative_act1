  ...
  <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-lg shadow p-5 flex flex-col">
        ...
        <p class="text-sm text-gray-600 flex-1">
          A community for computer science enthusiasts to discuss coding, algorithms, and emerging
          technologies. Share resources, ask questions, and collaborate on projects.
        </p>
      ...
      <div class="bg-white rounded-lg shadow p-5 flex flex-col">
        ...
        <p class="text-sm text-gray-600 flex-1">
          For lovers of books, poetry, and creative writing. Share recommendations, host readings,
          and collaborate on writing projects.
        </p>
        <div class="mt-4 flex justify-between items-center">
          <a href="#" class="text-indigo-600 hover:underline text-sm">View</a>
          <button class="bg-indigo-600 text-white px-3 py-1 rounded-md text-sm hover:bg-indigo-700">
    ...
    <div class="mt-8 bg-white rounded-lg shadow p-6 text-center">
      ...
      <p class="text-sm text-gray-600 mb-4">
        If you can’t find what you’re looking for, create a new community for your interest or study
        group.
      </p>
...
<script setup>
// No script logic yet, but you can later add dynamic data or API calls here
</script>
