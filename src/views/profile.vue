  ...
  <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6 space-y-8">
    ...
    <section class="bg-white rounded-lg shadow p-6">
      ...
      <p class="text-gray-700 mb-4">
        ...
        machine learning. In my spare time I enjoy participating in hackathons, building open‑source
        projects, and teaching coding to younger students.
      </p>
      ...
      <div class="border-t pt-4">
        <div class="flex items-start space-x-3">
          ...
          <div class="flex-1">
            ...
            <p class="mt-2 text-gray-700">
              Thanks to everyone who came to my workshop on deep learning! It was a great turnout
              and I hope you all found it useful.
            </p>
            <div class="mt-3 flex space-x-6 text-sm text-gray-600">
              <button class="flex items-center hover:text-indigo-600">
                <svg
